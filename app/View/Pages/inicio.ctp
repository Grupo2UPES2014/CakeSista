...
<div style="width: 500px;margin-left: auto;margin-right: auto;"><?php
    echo $this->Html->image('6.png', array('width' => 180, 'url' => 'http://aulaweb.upes.edu.sv/'));
//echo 'Aulaweb<br>';
    echo $this->Html->image('matriz.png', array('width' => 180, 'url' => 'http://www.upes.edu.sv/desafio/'));
