        ...
        <div id="sistacontainer">
            <div id="sistamenu">
                ...
                <div id="m_elementos">
                    ...
                    endforeach;
                    ?>
                    <a href="<?php echo $this->webroot . 'multimedia'; ?>"><div class="m_elemento"><div class="ico icoMediaCenter"></div><span>Centro Multimedia</span></div></a>
                    <a href="<?php echo $this->webroot . 'about'; ?>"><div class="m_elemento"><div class="ico icoInfo"></div><span>Acerca de SiSTA</span></div></a>
                </div>
                <div id="usuario"><span><?php echo $this->Session->read('Auth.User.alias'); ?></span><a href="<?php echo $this->webroot . 'usuarios/logout'; ?>"><div class="ico mini icoLogout"></div></a></div>
            </div>
            <div id="sistacontent">
